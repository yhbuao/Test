package com.haibo.myapplication.imageload;
...
public class ImageLoaderUtil {
    ...
    public static final int LOAD_STRATEGY_NORMAL = 0;//正常都加载
    public static final int LOAD_STRATEGY_ONLY_WIFI = 1;//开启数据流量不加载图片
    ...
    /**
     * get the network type (wifi,wap,2g,3g)获取网络类型
     *
     * @param context
     * @return
     */
